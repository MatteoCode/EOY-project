...
public class Constants {
	...
	public static class ObjectConstants {
		...
		public static int GetTreeOffsetY(int treeType) {
		    ...
		    int treeHeight = GetTreeHeight(treeType);

		    switch (treeType) {
		        case TREE_ONE:
		            return -treeHeight + Game.TILES_SIZE * 2;
		        case TREE_TWO:
		        case TREE_THREE:
		            return -treeHeight + (int) (Game.TILES_SIZE / 1.25f);
		        default:
		            return 0;
		    }
		}
		...
		public static int GetTreeHeight(int treeType) {
		    ...
		    switch (treeType) {
		        case TREE_ONE:
		            treeHeight = (int) (92 * Game.SCALE);
		            break;
		        case TREE_TWO:
		        case TREE_THREE:
		            treeHeight = (int) (54 * Game.SCALE);
		            break;
		        default:
		            treeHeight = 0;
		            break;
